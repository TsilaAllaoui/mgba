...
from gsa_common import environment_for_manifest,find_executable,find_manifest,load_manifest,sha256_file
...
def main()->int:
    ...
    autoqa=Path(args.autoqa).resolve() if args.autoqa else find_executable(
        ['mgba-mgba-autoqa','mgba-gbabr-autoqa'],Path(__file__),['mgba_AUTOQA','MGBA_GBABR_AUTOQA'])
